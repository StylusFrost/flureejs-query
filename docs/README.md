...
_Defined in [types.ts:16](https://github.com/StylusFrost/flureejs-query/blob/18565ea/src/types.ts#L16)_
...
_Defined in [types.ts:11](https://github.com/StylusFrost/flureejs-query/blob/18565ea/src/types.ts#L11)_
